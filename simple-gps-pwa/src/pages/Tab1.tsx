  ...
  return (
    <IonPage>
      ...
      <IonContent fullscreen>
        ...
        <IonButton expand="block" onClick={connectToDevice}>Connect To LORA Receiver</IonButton>
        ...
        <IonButton expand="block" onClick={handleCache}>Cache</IonButton>
        <IonButton expand="block" onClick={handleDisplay}>Display</IonButton>
        <p>{status}</p>
      </IonContent>
    </IonPage>
  );
